...
class Page{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a href="' . $this->url($up_row) . '"><span aria-hidden="true">&laquo;</span><span class="sr-only">上一页</span></a></li>' : '';

        //下一页
        $down_row  = $this->nowPage + 1;
        //$down_page = ($down_row <= $this->totalPages) ? '<a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a>' : '';
        $down_page = ($down_row <= $this->totalPages) ? '<li><a href="' . $this->url($down_row) . '"><span aria-hidden="true">&raquo;</span><span class="sr-only">下一页</span></a></li>' : '';
